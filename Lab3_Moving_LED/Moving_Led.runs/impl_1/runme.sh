...
HD_PWD='C:/Users/rbrin/Documents/GitHub/CPE-3020-VHDL_Design/Lab3_Moving_LED/Moving_Led.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MovingLed_Wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MovingLed_Wrapper.tcl -notrace
