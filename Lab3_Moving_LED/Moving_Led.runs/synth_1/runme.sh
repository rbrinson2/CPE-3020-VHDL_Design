...
HD_PWD='C:/Users/rbrin/Documents/GitHub/CPE-3020-VHDL_Design/Lab3_Moving_LED/Moving_Led.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MovingLed_Wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MovingLed_Wrapper.tcl
